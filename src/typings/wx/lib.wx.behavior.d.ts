...
declare namespace Behavior {
  ...
  interface IProperties<Data> {
    ...
    [prop: string]: {
      ...
      /** 监听器 */
      observer?: (this: BehaviorInstance<Data>, newValue: any, oldValue: any, path: string) => void;
    } | PropType;
  }
  ...
  interface IRelations {
    [pathOrBehavior: string]: {
      type: RelationType;
      target?: any;
      linked?(target: BehaviorInstance): void;
      linkChanged?(target: BehaviorInstance): void;
      unlinked?(target: BehaviorInstance): void;
    };
  }

  interface BehaviorInstance<D extends IAnyObject = any, T extends IAnyObject = any> {
    /** 页面的初始数据
      * 
  ...
  interface BehaviorConstructor {
    <D extends IAnyObject, T extends IAnyObject & BehaviorInstance>(
      options: BehaviorInstance<D, T> & T
    ): void;
  }

}
declare const Behavior: Behavior.BehaviorConstructor