...
var isPlainTextElement = makeMap('script,style,wxs', true);
var reCache = {};
...
// 判断是否是小程序原生组件的 map
var isWX = makeMap(
  'cover-image,cover-view,movable-area,movable-view,scroll-view,swiper,swiper-item,' +
  'view,icon,progress,rich-text,text,button,checkbox,checkbox-group,editor,form,input,'+
  'label,picker,picker-view,picker-view-column,radio,radio-group,slider,switch,textarea,'+
  'functional-page-navigator,navigator,audio,camera,image,live-player,live-pusher,video,'+
  'map,canvas,web-view,ad,official-account,open-data,native-component,'+
  'aria-component,navigation-bar,page-meta,template',true
)
...
var isReservedTag = function (tag) {
  return isWX(tag) ||isHTMLTag(tag) ||isSVG(tag)
};

function getTagNamespace (tag) {
  console.log('tag:', tag, isWX(tag))
  if (isWX(tag)) {
    return 'wx'
  }
  return 'component'
